...
const TestimonialCard = ({ testimonial }) => {
    ...
    return (
        ...
        >
            ...
            <div className="mt-6 pt-4 border-t border-brand-slate/10 flex justify-between items-end">
                <div>
                ...
                <div className="flex items-center gap-1.5 opacity-80" title="Posted on Google">
