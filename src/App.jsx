                                        ...
                                        <Row className="g-4">
                                            <Col xs={12} md={4}>
                                                <div className="border-l-2 border-brand-accent ps-4 mb-4 mb-md-0">
                                                    <h4 className="text-brand-primary font-bold m-0">12+ Years</h4>
                                                    <small className="uppercase tracking-tighter text-gray-500 font-bold">Experience</small>
                                                </div>
                                            </Col>
                                            <Col xs={12} md={4}>
                                                <div className="border-l-2 border-brand-accent ps-4 mb-4 mb-md-0">
                                                    <h4 className="text-brand-primary font-bold m-0">5-Star</h4>
                                                    <div className="flex items-center gap-2 mt-0.5">
                                                        ...
                                                        <small className="uppercase tracking-tighter text-gray-500 font-bold">Google Rating</small>
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xs={12} md={4}>
                                                <div className="border-l-2 border-brand-accent ps-4 mb-4 mb-md-0">
                                                    <h4 className="text-brand-primary font-bold m-0">IPHM Certified</h4>
                                                    <small className="uppercase tracking-tighter text-gray-500 font-bold">Globally Recognised</small>
                                                </div>
                                            </Col>
                                        </Row>
                                    </AnimatedContent>
